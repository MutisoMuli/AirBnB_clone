...
class HBNBCommand(cmd.Cmd):
    """ Contains HBNB console functionality"""
    ...
    def precmd(self, line):
        """Reformats cmd line for advanced cmd syntax.
    ...
    def emptyline(self):
        """ Overrides the empty line method of Command line """
        pass
    ...
    def help_create(self):
        """ Help develop info 4 the create method """
        print("Creates a class of any type")
        print("[Usage]: create <className>\n")

    def do_show(self, args):
        """ Individual object show method"""
        new = args.partition(" ")
        c_name = new[0]
        c_id = new[2]
    ...
    def help_show(self):
        """ Helps info 4 the show cmd """
        print("Shows an individual instance of a class")
        print("[Usage]: show <className> <objectId>\n")

    def do_destroy(self, args):
        """ Destroys object that have been specified """
        new = args.partition(" ")
        c_name = new[0]
        c_id = new[2]
        if c_id and ' ' in c_id:
