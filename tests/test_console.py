#!/usr/bin/python3
"""Defines all the unittests for console.py.
...
class TestHBNBCommand_prompting(unittest.TestCase):
    """Unit tests to test prompting of the HBNB cmd interpreter."""
...
class TestHBNBCommand_help(unittest.TestCase):
    """Unit tests for testing help msgs of the HBNB cmd interpreter."""
...
class TestHBNBCommand_exit(unittest.TestCase):
    """Unit tests to test exiting from the HBNB cmd interpreter."""
...
class TestHBNBCommand_create(unittest.TestCase):
    """Unit tests to test create from the HBNB cmd interpreter."""
...
class TestHBNBCommand_show(unittest.TestCase):
    """Unit tests to test show from the HBNB cmd interpreter"""
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """Unit tests to test destroy from the HBNB cmd interpreter."""
...
class TestHBNBCommand_all(unittest.TestCase):
    """Unittests to test all of the HBNB cmd interpreter."""
...
class TestHBNBCommand_update(unittest.TestCase):
    """Unittests to test update from the HBNB cmd interpreter."""
...
class TestHBNBCommand_count(unittest.TestCase):
    """Unittests to test count method of HBNB cmd interpreter."""
