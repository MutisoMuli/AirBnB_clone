#!/usr/bin/python3
"""Defines unittests for review.py model
...
class TestReview_instantiation(unittest.TestCase):
    """Unittests to test instantiation of the Review class."""
...
class TestReview_save(unittest.TestCase):
    """Unittests to test save method of the Review class."""
...
class TestReview_to_dict(unittest.TestCase):
    """Unittests to test to_dict method of the Review class."""
